...
function resolveImportFilePath(rawPath: string): string {
...
export function buildBambuConnectImportUrl(options: BambuConnectImportOptions): string {
...
export async function importFileViaBambuConnect(
  options: BambuConnectImportOptions
